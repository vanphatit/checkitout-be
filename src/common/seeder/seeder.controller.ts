...
export class SeederController {
  ...
  @ApiOperation({
    ...
    description:
      'Tạo dữ liệu mẫu bao gồm trạm, xe buýt, tuyến đường và lịch trình. Chỉ ADMIN mới có quyền thực hiện.',
  })
  @ApiResponse({
    status: 201,
    ...
    schema: {
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Seed dữ liệu hoàn thành thành công',
        },
        data: {
          type: 'object',
          properties: {
  ...
  async seedAll() {
    try {
      ...
      return {
        ...
        data: {
          message:
            'Đã tạo dữ liệu mẫu cho stations, buses, routes và schedulings',
  ...
  @ApiOperation({
    ...
    description:
      'Tạo các file Excel template với dữ liệu mẫu để import lịch trình. Bao gồm template đơn giản và comprehensive với hướng dẫn chi tiết.',
  })
  @ApiResponse({
    status: 201,
    ...
    schema: {
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Đã tạo Excel templates thành công',
        },
        data: {
          type: 'object',
          properties: {
            ...
            description: {
              type: 'string',
              example:
                'Templates bao gồm dữ liệu mẫu, hướng dẫn sử dụng, và danh sách tuyến/xe có sẵn',
            },
          },
        },
      },
      ...
      return {
        ...
        data: {
          ...
          usage: {
            ...
            comprehensive:
              'File đầy đủ với hướng dẫn, reference data và nhiều scenarios',
          },
        },
      };
    } catch (error) {
  ...
  @ApiOperation({
    ...
    description:
      'Endpoint tạm thời để test tạo Excel templates mà không cần authentication. Sẽ bị xóa sau khi test xong.',
  })
  @ApiResponse({
    status: 201,
      ...
      return {
        ...
        files: {
          ...
          comprehensiveTemplate: {
            ...
            description:
              'Template đầy đủ với 4 sheets: Hướng dẫn + Reference data + Import',
          },
        },
        features: [
  ...
  @ApiOperation({
    ...
    description:
      'Tạo Excel template với 100+ records thật từ database: stations, routes, buses, schedules. Nếu DB trống sẽ tạo fake data lớn.',
  })
  @ApiResponse({
    status: 201,
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Excel với dữ liệu thật đã được tạo thành công!',
        },
        data: {
          type: 'object',
          properties: {
            fileName: {
              type: 'string',
              example: 'checkitout_real_data_1732345678901.xlsx',
            },
            filePath: {
              type: 'string',
              example:
                'uploads/templates/checkitout_real_data_1732345678901.xlsx',
            },
            stats: {
              type: 'object',
              properties: {
