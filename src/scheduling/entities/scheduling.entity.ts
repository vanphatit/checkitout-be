...
import { IsDate, IsString, IsNumber, IsOptional, IsBoolean, Matches, IsEnum, Min, Max, IsNotEmpty, IsPhoneNumber } from 'class-validator';
...
export class Scheduling {
    ...
    @IsEnum(['scheduled', 'in-progress', 'completed', 'cancelled', 'delayed'], {
        message: 'Trạng thái phải là một trong: scheduled, in-progress, completed, cancelled, delayed'
    })
    status: string;
