...
export class ExcelProcessingService {
    ...
    async parseExcelFile(buffer: Buffer): Promise<any[]> {
        try {
            ...
            if (jsonData.length < 2) {
                throw new BadRequestException('File Excel phải có ít nhất 2 dòng (header + data)');
            }
    ...
    generateExcelTemplate(): Buffer {
        const template = [
            ['Tên tuyến đường', 'Biển số xe', 'Ngày khởi hành', 'Giờ khởi hành', 'Giờ đến', 'Giá vé', 'Tên tài xế', 'SĐT tài xế', 'GPLX', 'Ghi chú'],
            ['Sai Gon - Hong Ngu', '51B-12345', '2025-12-25', '08:30', '12:30', '150000', 'Nguyễn Văn A', '0987654321', 'B1234567', 'Lịch trình mẫu'],
            ['Hong Ngu - Sai Gon', '51B-12346', '2025-12-25', '14:00', '18:00', '150000', 'Trần Văn B', '0987654322', 'B1234568', ''],
        ];
