...
export class RouteController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Tuyến đường đã được tạo thành công',
  })
  ...
  @ApiOperation({
    summary:
      'Tạo tuyến đường với tính toán khoảng cách và thời gian tự động từ OpenStreetMap',
  })
  @ApiResponse({
    status: 201,
    description: 'Tuyến đường đã được tạo thành công',
  ...
  findByStations(
    ...
    return this.routeService.findByStations(
      originStationId,
  ...
  @ApiResponse({
    status: 200,
    description: 'Tuyến đường đã được cập nhật thành công',
  })
  @ApiResponse({ status: 404, description: 'Không tìm thấy tuyến đường' })
  @ApiResponse({ status: 403, description: 'Không có quyền truy cập' })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Tính toán lại khoảng cách và thời gian từ OpenStreetMap',
  })
  @ApiResponse({ status: 200, description: 'Đã tính toán lại thành công' })
  @ApiResponse({ status: 404, description: 'Không tìm thấy tuyến đường' })
  @ApiResponse({
    status: 400,
    description: 'Lỗi khi tính toán từ OpenStreetMap',
  })
  @ApiResponse({ status: 403, description: 'Không có quyền truy cập' })
